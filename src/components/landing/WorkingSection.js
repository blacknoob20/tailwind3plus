        ...
        <section className="pb-20 bg-gray-100 -mt-32">
            <div className="container max-w-7xl mx-auto px-4">
                <div className="flex flex-wrap relative z-50">
                    <StatusCard color="red" icon="gps_fixed" title="Obras">
                        Nuestros Arduo Trabajo
                        Está Reflejado
                        En Cifras.
                        <br/>
                        <Link to="/login" className="font-medium text-light-blue-500 mt-2 inline-block">Ver Mapa...</Link>
                    </StatusCard>
                ...
                {/* <div className="flex flex-wrap items-center mt-32">
                    <div className="w-full md:w-5/12 px-4 mx-auto">
                        ...
                        <a href="#pablo" className="font-medium text-light-blue-500 mt-2 inline-block" > Read More </a>
                    </div>
